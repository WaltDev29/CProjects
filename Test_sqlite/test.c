...
#define DB_FILE "C:/Users/AI-510-170/Downloads/sqlite-tools-win-x64-3500100/shopdb.sqlite"  // SQLite DB 파일명

int main() {
    sqlite3* db;
    sqlite3_stmt* stmt;
    const char* sql = "SELECT customer_id, name, age, grade, job, points FROM customer";
